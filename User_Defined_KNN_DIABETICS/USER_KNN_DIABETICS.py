...
from sklearn.datasets import load_diabetes  # Change this line
...
def PratikNeighbor():
    ...
    for i in range(len(diabetes.target)):
        print("ID: %d, Label %s, Feature: %s" % (i, diabetes.data[i], diabetes.target[i]))
